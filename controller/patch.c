                            ...
                            bool log_missing_bridge)
{
    ...
    SBREC_PORT_BINDING_FOR_EACH_EQUAL (binding, target, sbrec_port_binding_by_type) {
                    ...
                    const struct hmap *local_datapaths)
{
    ...
    add_bridge_mappings_by_type(ovs_idl_txn, br_int, existing_ports, chassis,
     ...
     */
    add_bridge_mappings_by_type(ovs_idl_txn, br_int, existing_ports, NULL,
          ...
          const struct hmap *local_datapaths)
{
     ...
     * should be there. */
    add_bridge_mappings(ovs_idl_txn, bridge_table, ovs_table, br_int,
                        &existing_ports, chassis, local_datapaths);
