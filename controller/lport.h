...
const struct sbrec_port_binding *lport_lookup_by_name(const char *name);

const struct sbrec_port_binding *lport_lookup_by_key(uint64_t dp_key,
                                                     uint64_t port_key);

const struct sbrec_datapath_binding *datapath_lookup_by_key(uint64_t dp_key);
