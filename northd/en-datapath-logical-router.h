...
void *en_datapath_logical_router_init(struct engine_node *node,
                                      struct engine_arg *args);

void en_datapath_logical_router_run(struct engine_node *node , void *data);
...
void *en_datapath_synced_logical_router_init(struct engine_node *node,
                                             struct engine_arg *args);

void en_datapath_synced_logical_router_run(struct engine_node *node,
                                           void *data);
